...
class SMSApi
{
    ...
    {
        list($response) = $this->sendSMSToTargetWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation sendSMSToTargetWithHttpInfo
     *
     * Send SMS notification to user
     *
     * @param  \IterableIA\Iterable\Model\TargetSMSRequest $body Recipient and email ID (required)
    ...
    /**
     * Operation sendSMSToTargetAsync
     *
     * Send SMS notification to user
     *
     * @param  \IterableIA\Iterable\Model\TargetSMSRequest $body Recipient and email ID (required)
     ...
     */
    public function sendSMSToTargetAsync($body)
    {
        return $this->sendSMSToTargetAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sendSMSToTargetAsyncWithHttpInfo
     *
     * Send SMS notification to user
     *
     * @param  \IterableIA\Iterable\Model\TargetSMSRequest $body Recipient and email ID (required)
     ...
     */
    protected function sendSMSToTargetRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sendSMSToTarget'
            );
        }

        $resourcePath = '/api/sms/target';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
