...
class WorkflowsApi
{
    ...
    {
        list($response) = $this->triggerWorkflowWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function triggerWorkflowAsync($body)
    {
        return $this->triggerWorkflowAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function triggerWorkflowRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling triggerWorkflow'
            );
        }

        $resourcePath = '/api/workflows/triggerWorkflow';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
