...
class WebPushApi
{
    ...
    {
        list($response) = $this->sendWebPushToTargetWithHttpInfo($body);
        return $response;
    }

    /**
     * Operation sendWebPushToTargetWithHttpInfo
     *
     * Send web push notification to user
     *
     * @param  \IterableIA\Iterable\Model\TargetWebPushRequest $body Recipient and email id (required)
    ...
    /**
     * Operation sendWebPushToTargetAsync
     *
     * Send web push notification to user
     *
     * @param  \IterableIA\Iterable\Model\TargetWebPushRequest $body Recipient and email id (required)
     ...
     */
    public function sendWebPushToTargetAsync($body)
    {
        return $this->sendWebPushToTargetAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation sendWebPushToTargetAsyncWithHttpInfo
     *
     * Send web push notification to user
     *
     * @param  \IterableIA\Iterable\Model\TargetWebPushRequest $body Recipient and email id (required)
     ...
     */
    protected function sendWebPushToTargetRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling sendWebPushToTarget'
            );
        }

        $resourcePath = '/api/webPush/target';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
